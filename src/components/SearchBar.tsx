  ...
  return (
    <div className="relative items-center w-full group">
      <input
        ...
        type="text"
        value={text}
        className="w-full pr-10 border-0 font-medium text-neutral-700 border-b-2 border-gray-800 focus:outline-none focus:border-green-500 placeholder:text-neutral-500 pb-2"
        onFocus={() => {
          setIsClicked(true);
        }}
        onBlur={() => {
